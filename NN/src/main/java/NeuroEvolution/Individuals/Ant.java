...
public class Ant extends Individual{
    ...
    ImageIcon up = new ImageIcon(Paths.get("").toAbsolutePath()+"\\NN\\src\\main\\resources\\images\\antUp.png");
    ImageIcon left = new ImageIcon(Paths.get("").toAbsolutePath()+"\\NN\\src\\main\\resources\\images\\antLeft.png");
    ImageIcon right = new ImageIcon(Paths.get("").toAbsolutePath()+"\\NN\\src\\main\\resources\\images\\antRight.png");
    ImageIcon down = new ImageIcon(Paths.get("").toAbsolutePath()+"\\NN\\src\\main\\resources\\images\\antDown.png");
